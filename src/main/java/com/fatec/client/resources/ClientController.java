...
public class ClientController {
    ...
    @PostMapping
    public ResponseEntity<Client> saveClient(@RequestBody Client client){//* è dentro do corpo que o cliente json tá incluido, essa linha diz que o vier de dentro do json, a gente salva no client, a estrutura do Client tem que bater com o json(não pode ser diferente)*/
